<template>
  ...
  <!--eslint-disable-->
  <edit-regional v-if="editModalStatus" v-on:closeModal="editModal" />
</template>

<script>
import { defineComponent, ref } from 'vue'
import FillButton from '@/components/ticket-it/buttons/FillButton.vue'
import EditRegional from '@/views/ticket-it/panel-view/user-administrator/regional/edit-regional/EditRegional.vue'

export default defineComponent({
  name: 'regional-table',
  components: {
    'fill-button': FillButton,
    'edit-regional': EditRegional
  },
  props: {
    tableData: {
      type: Array,
